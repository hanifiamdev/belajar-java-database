...
public class MetaDataTest {
    ...
    void testParameterMetaData() throws SQLException {
        ...
        System.out.println(parameterMetaData.getParameterType(2));*/ //Belum supprt untuk driver MySQL yang digunakan
    ...
    void testResultSetMetaData() throws SQLException {
        ...
        for (int i = 1; i <= resultSetMetaData.getColumnCount(); i++) {
            ...
            System.out.println("Type : " + resultSetMetaData.getColumnType(i)); // ini akan mendapatkan nilai constant data java.sql.Type
